...
class _AccountInformationState extends State<AccountInformation> {
  ...
  void initState() {
    super.initState();
    context.read<InfluencerAccountDetailsProvider>().init();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<InfluencerAccountDetailsProvider>(
        ...
        return Scaffold(
          ...
          body: LoadingOverlay(
            ...
            progressIndicator: const AlertLoader(
              message: 'Adding Account Details',
            ),
            child: Padding(
                      ...
                      onTap: () async {
                        if (isValidForm()) {
                          ...
                          try {
                            ...
                            final response = await provider.postAccountDetails(
                              id: influencerId,
                            ...
                            context
                                .showError('Error adding account details: $e');
                          }
