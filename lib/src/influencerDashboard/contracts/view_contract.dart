...
class InfluencerCampaignContract extends StatefulWidget {
  const InfluencerCampaignContract({super.key});

  @override
  State<InfluencerCampaignContract> createState() =>
      _InfluencerCampaignContractState();
}

class _InfluencerCampaignContractState
    extends State<InfluencerCampaignContract> {
                ...
                Center(
                  child: Padding(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage:
                          const AssetImage('assets/images/shinytictok.png'),
                    ),
                  ),
                ),
                Container(
